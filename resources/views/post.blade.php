            ...
            <div class="row justify-content-center">
                <div class=" col-lg-9   mb-5 mb-lg-0">
                    <article>
                        <div class="post-slider mb-4">
                            <img src="{{ url('assets/img/post/post-2.jpg') }}" class="card-img" alt="post-thumb">
                            <img src="{{ url('assets/img/post/post-2.jpg') }}" class="card-img" alt="post-thumb">
                        </div>
                        ...
                        <ul class="card-meta my-3 list-inline">
                            <li class="list-inline-item">
                                ...
                                @endphp
                                <a href="{{ url("author/$username") }}" class="card-meta-author">
                                    <img src="{{ url('assets/img/john-doe.jpg') }}" loading="lazy">
                                    <span>{{ $post->author->name }}</span>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <i class="ti-timer"></i>{{ $post->readDuration() }} Min To Read
                            </li>
                            <li class="list-inline-item">
                            ...
                            <li class="list-inline-item">
                                <a href="{{ route('category', ['category' => $post->category->slug]) }}"
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="mb-5 border-top mt-4 pt-5">
                        ...
                        <div class="media d-block d-sm-flexW mb-4 pb-4">
                            <a class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                                <img src="{{ url('assets/img/post/user-01.jpg') }}" class="mr-3 rounded-circle"
                                    alt="">
                            </a>
                        ...
                        <div class="media d-block d-sm-flex">
                            <div class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                                <img class="mr-3" src="{{ url('assets/img/post/arrow.png') }}" alt="">
                                <a href="#!"><img src="{{ url('assets/img/post/user-02.jpg') }}"
