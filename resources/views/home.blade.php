            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <ul class="list-inline widget-list-inline">
                        ...
                        <li class="list-inline-item"><a href="tags.html">DevOps</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <h2 class="h5 section-title">Most Liked</h2>
                    @isset($mostLikedPosts)
                        <x-vertical-post-card title="{{ $mostLikedPosts->title }}" slug="{{ $mostLikedPosts->slug }}"
                            excerpt="{{ $mostLikedPosts->excerpt }}" author="{{ $mostLikedPosts->author->name }}"
                            username="{{ $mostLikedPosts->author->username }}"
                            readDuration="{{ $mostLikedPosts->readDuration() }}"
                            publishedDate="{{ $mostLikedPosts->created_at->diffForHumans() }}"
                            categoryName="{{ $mostLikedPosts->category->name }}" categorySlug="{{ $mostLikedPosts->category->slug }}" views="{{ $mostLikedPosts->views }}"
                            likes="{{ $mostLikedPosts->likes }}"  />
                    @endisset
                </div>
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{ url('assets/img/post/post-4.jpg') }}">
                            <div class="ml-3">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    @isset($popularPosts)
                        <x-vertical-post-card title="{{ $popularPosts->title }}" slug="{{ $popularPosts->slug }}"
                            excerpt="{{ $popularPosts->excerpt }}" author="{{ $popularPosts->author->name }}"
                            username="{{ $popularPosts->author->username }}"
                            readDuration="{{ $popularPosts->readDuration() }}"
                            publishedDate="{{ $popularPosts->published_at->diffForHumans() }}"
                            categoryName="{{ $popularPosts->category->name }}" categorySlug="{{ $popularPosts->category->slug }}" views="{{ $popularPosts->views }}"
                            likes="{{ $popularPosts->likes }}" />
                    @endisset
            ...
            <div class="row justify-content-center">
                <aside class="col-lg-4 @@sidebar">
                    ...
                    {{-- <div class="widget widget-about">
                        ...
                        <img class="img-fluid" src="{{ url('assets/img/author.jpg" alt="Themefisher">
                    ...
                    <!-- Promotion -->
                    {{-- <div class="promotion">
                        <img src="{{ url('assets/img/promotion.jpg" class="img-fluid w-100">
                    ...
                    {{-- <div class="widget widget-author">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{ url('assets/img/john-doe.jpg">
                            </div>
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{ url('assets/img/kate-stone.jpg">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{ url('assets/img/john-doe.jpg" alt="John Doe">
                            </div>
                            <div class="media-body">
                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    @foreach ($recentPosts as $recentPost)
                        <x-horizontal-post-card title="{{ $recentPost->title }}" slug="{{ $recentPost->slug }}"
                            excerpt="{{ $recentPost->excerpt }}" author="{{ $recentPost->author->name }}"
                            username="{{ $recentPost->author->username }}"
                            readDuration="{{ $recentPost->readDuration() }}"
                            publishedDate="{{ $recentPost->published_at->diffForHumans() }}"
                            categoryName="{{ $recentPost->category->name }}" categorySlug="{{ $recentPost->category->slug }}" views="{{ $recentPost->views }}"
                        ...
                        <div class="row card-body">
                            <div class="col-md-4 mb-4 mb-md-0">
                                <div class="post-slider slider-sm">
                                    <img src="{{ url('assets/img/post/post-3.jpg') }}" class="card-img" alt="post-thumb"
                                ...
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            <img src="{{ url('assets/img/john-doe.jpg') }}">
                                            <span>Mark Dinn</span>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                    ...
                    <article class="card mb-4">
                        <div class="row card-body">
                            <div class="col-md-4 mb-4 mb-md-0">
                                <div class="post-slider slider-sm">
                                    <img src="{{ url('assets/img/post/post-7.jpg') }}" class="card-img" alt="post-thumb"
                                        style="height:200px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row card-body">
                            <div class="col-12">
                                ...
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            <img src="{{ url('assets/img/kate-stone.jpg" alt="Kate Stone">
                    ...
                    {{-- <article class="card mb-4">
                        <div class="row card-body">
                            <div class="col-md-4 mb-4 mb-md-0">
                                <div class="post-slider slider-sm">
                                    <img src="{{ url('assets/img/post/post-5.jpg') }}" class="card-img" alt="post-thumb"
                                        style="height:200px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-md-8">
                    ...
                    <article class="card mb-4">
                        <div class="row card-body">
                            <div class="col-md-4 mb-4 mb-md-0">
                                <div class="post-slider slider-sm">
                                    <img src="{{ url('assets/img/post/post-8.jpg') }}" class="card-img" alt="post-thumb"
                                        style="height:200px; object-fit: cover;">
                                    <img src="{{ url('assets/img/post/post-9.jpg') }}" class="card-img" alt="post-thumb"
                                        style="height:200px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-md-8">
                                ...
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            <img src="{{ url('assets/img/john-doe.jpg') }}" alt="John Doe">
                                            <span>John Doe</span>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
