            ...
            <div class="row ">
                ...
                <aside class="col-lg-4 @@sidebar">
                    ...
                    {{-- <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            <x-category-list name="{{ $category->name }}" slug="{{ $category->slug }}" total="{{ $category->posts->count() }}" />
                            @endforeach
                        </ul>
                    </div> --}}
                    ...
                    <!-- Social -->
                    <div class="widget">
                        <h4 class="widget-title"><span>Brand Social Links</span></h4>
                ...
                <div class="col-lg-8">
                    <div class=" mb-5 mb-lg-0">
                        ...
                        <h2 class="h5 section-title">Test Total : {{ $posts->count() }}</h2>
                        <div class="row">

                            @foreach ($posts as $post)
                                <div class="col-lg-12 col-sm-12">
                                    <x-horizontal-post-card title="{{ $post->title }}" slug="{{ $post->slug }}"
